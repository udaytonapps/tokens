...
class CommonService
{
    ...
    public static function init()
    {
        ...
        //     array("user_id" => "000000000", "person_name_given" => "Une", "person_name_family" => "Cooperative", "person_contact_email_primary" => "never@loggedin.edu", "person_name_full" => "Une Cooperative", "role" => "Learner", "groups" => array(array("title" => "Group1"))),
